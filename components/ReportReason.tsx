...
const ReportReason = () => {
    const [reason, setReason] = useState<string>('');//input창을 위해
    const navigation = useNavigation();
    const [temp, setTemp] = useState<string>();//picker에 표시하기위해
    return (
        <View style={reportStyles.container}>
            ...
            />
            <View style={{ width: '85%', height: '12.5%', alignItems: 'center', justifyContent: 'center' }}>
